# Contributing to DictionaryMark

Thank you for your interest in contributing to DictionaryMark! We welcome contributions from the community and
...
- **Environment**: Operating system, .NET version, DictionaryMark version
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/demaconsulting/DictionaryMark.git
   cd DictionaryMark
   ```
...
dotnet run --project src/DemaConsulting.DictionaryMark \
...
DictionaryMark uses [DemaConsulting.ReqStream][reqstream] for requirements traceability:
...
By contributing to DictionaryMark, you agree that your contributions will be licensed under the MIT License.

Thank you for contributing to DictionaryMark!

[code-of-conduct]: https://github.com/demaconsulting/DictionaryMark/blob/main/CODE_OF_CONDUCT.md
...
[discussions]: https://github.com/demaconsulting/DictionaryMark/discussions
[issues]: https://github.com/demaconsulting/DictionaryMark/issues
[security]: https://github.com/demaconsulting/DictionaryMark/blob/main/SECURITY.md
