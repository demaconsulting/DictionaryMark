...
We take the security of DictionaryMark seriously. If you believe you have found a
...
When using DictionaryMark, we recommend following these security best practices:

### Input Validation

- Validate command-line arguments and file paths before processing
- Be cautious when processing data from untrusted sources
- Use the latest version of DictionaryMark to benefit from security updates

### Dependencies

- Keep DictionaryMark and its dependencies up to date
...
- Run DictionaryMark with the minimum required permissions
- Avoid running DictionaryMark as a privileged user unless necessary
...
DictionaryMark reads and writes files on the local file system. Users should:
...
DictionaryMark relies on third-party packages. We:
...
Thank you for helping keep DictionaryMark and its users safe!

[security-advisories]: https://github.com/demaconsulting/DictionaryMark/security/advisories
