...
(version display and help display), prints a pass/fail summary, and optionally writes the
results to a TRX or JUnit XML file. Each test runs the real `Program` logic with a
